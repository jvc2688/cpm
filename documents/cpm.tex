...
One possible way to solve this kind of edge effect 
  but still preserve the transit signals to do the simultaneous fitting 
...
That is,  
  ...
  a comprehensive model for both all components in the data (systematics, stellar variabilities and transits)  can be made. In this kind of model, there is no need for train-and-test framework,
