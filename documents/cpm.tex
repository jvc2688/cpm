...
The scope of this project is an intervention---\name---that makes the \Kepler\ transit photometry more precise.\Bernhard{doesn't this contradict our statement that we only care about transits and we remove the lightcurve variability? Suggestion: The scope of this project is an intervention---\name---that makes the \Kepler\ transit photometry more precise.}
\Dun{Yes, I think so and made this change.}
