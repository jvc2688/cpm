...
There are also \emph{intra-pixel} sensitivity variations that can contribute \citep{whitepaper} (\todo{cite white paper; Spitzer results}).
...
One such method---one that is designed to describe or model spacecraft-induced problems
  ...
  is the \Kepler\ Presearch (\sic) Data Conditioning (PDC) method \citep{pdc1}, (\todo{citation}).
